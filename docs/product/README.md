...
Product docs state what users and operators can rely on without becoming source
tours.

| Behavior | Doc |
| --- | --- |
| Service scope, users, authentication, clients, and non-goals | [Service](service.md) |
| Search modes, filters, matching, screening, results, and mark detail | [Search](search.md) |
