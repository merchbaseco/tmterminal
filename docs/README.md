...
| Change deployment, backups, artifact storage, or hosting | [Implementation plan](plan.md), [Mac mini deployment](operations/deployment.md), [Mac mini hosting decision](adr/0003-host-v1-on-mac-mini.md) |
