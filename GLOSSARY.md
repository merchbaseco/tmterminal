...
Shared nouns for Trademark Terminal. Use these words in code, tickets, and
prose. Do not invent corpus-era synonyms.

`CONTEXT.md` is a symlink to this file so Matt Pocock skills keep working.
